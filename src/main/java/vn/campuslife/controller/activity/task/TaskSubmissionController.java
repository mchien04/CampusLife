...
public class TaskSubmissionController {
    ...
    public ResponseEntity<Response> submitTask(@PathVariable Long taskId,
        ...
        try {
            ...
            Response response = taskSubmissionService.submitTask(taskId, studentId, content, files, images);
    ...
    public ResponseEntity<Response> updateSubmission(@PathVariable Long submissionId,
        ...
        try {
            ...
            Response response = taskSubmissionService.updateSubmission(submissionId, studentId, content, files, images);
            return ResponseEntity.ok(response);
        } catch (Exception e) {
            return ResponseEntity.badRequest()
