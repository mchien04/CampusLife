    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http,
        ...
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.GET, "/api/registrations/activities/*/report")
                        .hasAnyRole("ADMIN", "MANAGER")
                        .requestMatchers(HttpMethod.GET, "/api/registrations/activities/*/export")
                        .hasAnyRole("ADMIN", "MANAGER")
                        ...
                        .hasAnyRole("STUDENT", "ADMIN", "MANAGER")
                        .requestMatchers(HttpMethod.GET, "/api/scores/export")
                        .hasAnyRole("ADMIN", "MANAGER")
                        ...
                        .hasAnyRole("ADMIN", "MANAGER")
                        // Manual score entry - Admin/Manager only
                        .requestMatchers(HttpMethod.POST, "/api/scores/manual", "/api/scores/manual/**")
                        .hasAnyRole("ADMIN", "MANAGER")
                        // Score appeals
                        .requestMatchers(HttpMethod.POST, "/api/scores/appeals/evidence").hasRole("STUDENT")
                        .requestMatchers(HttpMethod.POST, "/api/scores/appeals").hasRole("STUDENT")
                        .requestMatchers(HttpMethod.GET, "/api/scores/appeals/my").hasRole("STUDENT")
                        .requestMatchers(HttpMethod.PUT, "/api/scores/appeals/*/withdraw").hasRole("STUDENT")
                        .requestMatchers(HttpMethod.POST, "/api/scores/appeals/*/decide/preview")
                        .hasAnyRole("ADMIN", "MANAGER")
                        .requestMatchers(HttpMethod.PUT, "/api/scores/appeals/*/decide").hasAnyRole("ADMIN", "MANAGER")
                        .requestMatchers(HttpMethod.PUT, "/api/scores/appeals/*/close").hasAnyRole("ADMIN", "MANAGER")
                        .requestMatchers(HttpMethod.POST, "/api/scores/appeals/*/messages")
                        .hasAnyRole("STUDENT", "ADMIN", "MANAGER")
                        .requestMatchers(HttpMethod.GET, "/api/scores/appeals").hasAnyRole("ADMIN", "MANAGER")
                        .requestMatchers(HttpMethod.GET, "/api/scores/appeals/*")
                        .hasAnyRole("STUDENT", "ADMIN", "MANAGER")
